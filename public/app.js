...
function renderEngagementLists(){
  ...
  const ps=$('pushStats');if(ps)ps.textContent=`מכשירים רשומים: ${pushStats.total||0} · Android ${pushStats.android||0} · Web ${pushStats.web||0} · לימודים ${pushStats.study||0} · פנימייה ${pushStats.dorm||0} · מנהלים ${pushStats.admin||0}`;
}
