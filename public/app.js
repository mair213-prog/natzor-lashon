...
async function saveReminder(id){
  ...
  if(!off&&!email)return alert('בחר אימייל או ביטול תזכורת');
...
async function saveMyReminder(){
  ...
  if(!ch)return alert('חובה לבחור אימייל');
